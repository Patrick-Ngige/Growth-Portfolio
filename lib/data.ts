...
export const caseStudies: CaseStudy[] = [
  ...
  },
  {
    ...
    images: ['/images/work/kenafric/kenafric-home.png'],
  ...
  },
  {
    ...
    images: ['/images/work/tomoca-coffee/tomoca-home.png'],
  ...
  },
  {
    ...
    images: ['/images/work/kap/kap-home.png'],
    tags: ['Healthcare', 'WordPress', 'Maintenance'],
  },
  {
    id: 'mon-reve-du-lac',
    company: 'Mon Reve Du Lac',
    industry: 'Hospitality / Tourism',
    category: 'web',
    metricValue: 'Naivasha',
    metricLabel: 'Lakeside Hotel Website',
    context: 'Development and maintenance of the website for Mon Reve Du Lac, a hotel on Lake Naivasha.',
    challenge: 'The hotel needed a website that captured its lakeside setting for prospective guests.',
    approach: 'Development and maintenance of the Mon Reve Du Lac website.',
    result: 'Site live, showcasing the property\'s Naivasha lakeside location.',
    technicalExecution: ['Website development and maintenance'],
    tags: ['Hospitality', 'Tourism', 'Maintenance'],
  },
  {
    id: 'kianda-school',
    ...
    images: ['/images/work/kianda-school/kianda-home.png'],
